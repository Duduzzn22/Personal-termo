...
export default async function IaPage() {
  ...
  return <div className="space-y-4">
    ...
    <PersonalAIClient configured={Boolean(process.env.AI_GATEWAY_API_KEY)} />
    <p className="text-xs text-slate-400">A IA é consultiva: não altera alunos, pagamentos, agenda ou mensagens automaticamente.</p>
  </div>;
}
