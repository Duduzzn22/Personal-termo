...
export function PersonalAIClient({ configured }: { configured: boolean }) {
  ...
  return <div className="space-y-4">
    {!configured && <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">A interface está pronta, mas falta configurar <code>GEMINI_API_KEY</code> na Vercel para ativar as respostas.</div>}
